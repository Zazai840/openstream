...
step "Enable OpenStream or Electron under Microphone."
...
step "Enable OpenStream or Electron under Input Monitoring."
pause "Press Enter after checking Input Monitoring access."
open_url "x-apple.systempreferences:com.apple.preference.security?Privacy_Accessibility"
step "Enable OpenStream or Electron under Accessibility."
pause "Press Enter after checking Accessibility access."
step "If an entry is absent, return to OpenStream and hold Cmd+Shift+D once to trigger its prompt."
